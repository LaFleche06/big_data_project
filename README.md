...
Le dashboard a été réalisé sur Databricks afin d’offrir une vue complète sur les données météorologiques du Sénégal et leurs tendances, mises en perspective avec certaines données agricoles et économiques. 
